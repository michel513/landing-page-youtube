...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    layerStates.forEach((ls, i) => {
      tl.fromTo(
        ls.el,
        { xPercent: ls.start, opacity: 0, visibility: 'hidden' },
        { xPercent: 0, opacity: 1, visibility: 'visible', duration: 0.5, ease: 'power4.out' },
        i * 0.07
      );
    });
    ...
    tl.fromTo(
      panel,
      { xPercent: panelStart, opacity: 0, visibility: 'hidden' },
      { xPercent: 0, opacity: 1, visibility: 'visible', duration: panelDuration, ease: 'power4.out' },
      panelInsertTime
    );
        ...
        >
          {(() => {
            ...
            return arr.map((c, i) => (
              <div
                key={i}
                className="sm-prelayer absolute top-0 right-0 h-full w-full opacity-0 invisible"
                style={{ background: c }}
              />
            ));
          })()}
